...
/**
 * clone of the AssessmentManager intent is to modify to reroute the lectern inputs to the collaborative manager 
 * or to integrate the collaborative manager class into this script
