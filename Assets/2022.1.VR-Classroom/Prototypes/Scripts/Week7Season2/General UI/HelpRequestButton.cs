...
public class HelpRequestButton : MonoBehaviour
{
    ...
    public float id; // set in HelpRequestUI.cs
    
    void Start()
    {
        // check to see if a request button should display that a student has requested help or
        // show the confirmation to end a help request session
        if(id != 1){
